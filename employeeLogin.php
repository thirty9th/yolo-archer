...
function checkLoginInfo($inUsername, $inPassword)
{
	...
	$query = 'select username from employee where username = "' . $inUsername . '"';
	...
	$query = 'select password from employee where username = "' . $inUsername . '"';
	...
	if ($row['password'] == $inPassword)
	{
		...
		$_SESSION['username'] = $inUsername;
                $query = 'select department from employee where username = "' . $inUsername . '"';
                $result = mysqli_query($con, $query);
                $row = mysqli_fetch_array($result);
